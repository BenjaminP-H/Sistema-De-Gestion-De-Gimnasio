...
$pdo->prepare("UPDATE gyms SET estado = 'activo' WHERE id = ?")->execute([$gym_id]);
$pdo->prepare("INSERT INTO auditoria (gym_id, usuario_id, accion, detalle) VALUES (?, ?, 'activar', 'Gym reactivado')")
