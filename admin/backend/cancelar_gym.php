...
$pdo->prepare("UPDATE gyms SET estado = 'cancelado' WHERE id = ?")->execute([$gym_id]);
$pdo->prepare("INSERT INTO auditoria (gym_id, usuario_id, accion, detalle) VALUES (?, ?, 'cancelar', 'Gym cancelado definitivamente')")
